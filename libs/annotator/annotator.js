...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    function Annotator(element, options) {
      ...
      this.onComment = __bind(this.onComment, this);
    ...
    Annotator.prototype._setupEditor = function() {
      ...
      this.editor.hide().on('hide', this.onEditorHide).on('save', this.onEditorSubmit).on('comment', this.onComment);
    ...
    Annotator.prototype._setupDocumentEvents = function() {
      $(document).bind({
        ...
        "WebMenuPluginTouch": this.checkForEndSelection
      });
      return this;
    };
    ...
    Annotator.prototype.setupAnnotation = function(annotation) {
      ...
      var _this = this;
      $(annotation.highlights).click(function(event){
            if($(this).attr("color") == 'comment'){
              return;
            }
            if (event != null) {
              event.preventDefault();
            }
            _this.showEditor(annotation, null);
            _this.editor.load(annotation);
        });
      $(annotation.highlights).attr('data-annotation-id', annotation.id);
      if(annotation.color){
          if(annotation.color == 'yellow'){
              for(var i=0; i < annotation.highlights.length; i++){
                annotation.highlights[i].style.backgroundColor = "rgba(236, 232, 48, 0.5)";
                annotation.highlights[i].style.paddingTop = "2px";
                annotation.highlights[i].style.paddingBottom = "2px";
                }
          }
          if(annotation.color == 'fucsia'){
              for(var i=0; i < annotation.highlights.length; i++){
                    annotation.highlights[i].style.backgroundColor = "rgba(214, 79, 158, 0.5)";
                    annotation.highlights[i].style.paddingTop = "2px";
                    annotation.highlights[i].style.paddingBottom = "2px";
                }
          }
          if(annotation.color == 'blue'){
              for(var i=0; i < annotation.highlights.length; i++){
                    annotation.highlights[i].style.backgroundColor = "rgba(101, 176, 195, 0.5)";
                    annotation.highlights[i].style.paddingTop = "2px";
                    annotation.highlights[i].style.paddingBottom = "2px";
                }
          }
          if(annotation.color == 'red'){
              for(var i=0; i < annotation.highlights.length; i++){
                    annotation.highlights[i].style.backgroundColor = "rgba(237, 102, 44, 0.5)";
                    annotation.highlights[i].style.paddingTop = "2px";
                    annotation.highlights[i].style.paddingBottom = "2px";
                }
          }
          if(annotation.color == 'comment'){
              for(var i=0; i < annotation.highlights.length; i++){
                    annotation.highlights[i].style.backgroundColor = "rgba(0, 0, 0, 0.2)";
                    annotation.highlights[i].style.paddingTop = "2px";
                    annotation.highlights[i].style.paddingBottom = "2px";
                }
                var annotationElement = $(annotation.highlights[0]);
                $(annotationElement).attr("data-section-id", annotation.id);
                $(annotationElement).addClass("commentable-section");

          }
          $(annotationElement).attr("color", annotation.color);
      }
      return annotation;
    };
      ...
      loader = function(annList) {
        ...
        if (annList.length > 0) {
          return setTimeout((function() {
            ...
            clone.forEach(function(tmpAnnotation){
                $(tmpAnnotation.highlights).click(function(event){
                  if(!$(event.target).closest('.side-comment').length){
                    if(tmpAnnotation.color != 'comment'){
                        if (event != null) {
                          event.preventDefault();
                          _this.showEditor(tmpAnnotation, null);
                          this.color = $(event.target).attr('id');
                        }
                      }
                      else{
                        event.stopPropagation();
                        $('.side-comment[data-relative-id=' + $(tmpAnnotation.highlights).attr('data-section-id') + ']').find('.marker').click();
                      }
                  }
                });
    ...
    Annotator.prototype.showEditor = function(annotation, location) {
      ...
      var matches, matrix;
      if($('#pdfZoom').length){
        matches = $("book-annotator").css('transform').match(matrixRegex);
        $("book-annotator").css('transform', 'scale(1)');
        matrix = $('#pdfZoom').css('transform');
        $('#pdfZoom').css('transform', 'none');
      }
      var offsetEl = this.wrapper[0];
      if ((_ref1 = $(offsetEl).css('position')) !== 'absolute' && _ref1 !== 'fixed' && _ref1 !== 'relative') {
        offsetEl = $(offsetEl).offsetParent()[0];
      }
      offset = $(offsetEl).offset();
      location = {
        top: $(annotation.highlights).offset().top - offset.top,
        left: $(annotation.highlights).offset().left + ($(annotation.highlights).width() / 2) - offset.left
      }
      if($('#pdfZoom').length){
        $("book-annotator").css('transform', 'scale(' + matches[1] + ')');
        $('#pdfZoom').css('transform', matrix);
        if(window.cordova){
          $('.annotator-editor').css('transform', 'scale(2.3)');
        }
    ...
    Annotator.prototype.onEditorHide = function() {
      if(this.editor.mustDelete === true){
            this.deleteAnnotation(this.editor.annotation);
            this.editor.mustDelete = false;
      }
    ...
    Annotator.prototype.onComment = function(annotation) {
        return this.publish('addingComment', [annotation]);
    }
    ...
    Annotator.prototype.checkForStartSelection = function(event) {
        if(!event || ! event.target || !$(event.target.parentElement) || !$(event.target.parentElement).hasClass('annotator-controls')){
  ...
  Annotator.Editor = (function(_super) {
    ...
    Editor.prototype.events = {
      ...
      ".colorToChoose click": "chooseColor",
      "#yellow click": "yellowColor",
      "#fucsia click": "fucsiaColor",
      "#blue click": "blueColor",
      "#red click": "redColor",
      "#cancelHighlight click": "cancelHighlight",
    ...
    Editor.prototype.chooseColor = function(event){
        var _this = this;
        var currentAnnotation = this.annotation;
        this.annotation.color = $(event.target).attr('id');
        this.submit();
    }

    Editor.prototype.cancelHighlight = function(event){
        for(var i=0; i < this.annotation.highlights.length; i++){
            $(this.annotation.highlights[i]).contents().unwrap();
        }
        this.mustDelete = true;
        this.hide();
    }

    Editor.prototype.showComment = function(event){
        this.comment();
       event.stopPropagation();
       this.hide();
    }
    Editor.prototype.yellowColor = function(){
        for(var i=0; i < this.annotation.highlights.length; i++){
            this.annotation.highlights[i].style.backgroundColor = "rgba(236, 232, 48, 0.5)";
            this.annotation.highlights[i].style.paddingTop = "2px";
            this.annotation.highlights[i].style.paddingBottom = "2px";
        }
        this.annotation.color = "yellow";
    }

    Editor.prototype.fucsiaColor = function(){
        var annotation = this.annotation.highlights;
        for(var i=0; i < annotation.length; i++){
            annotation[i].style.backgroundColor = "rgba(214, 79, 158, 0.5)";
            annotation[i].style.paddingTop = "2px";
            annotation[i].style.paddingBottom = "2px";
        }
        this.annotation.color = "fucsia";
    }

    Editor.prototype.blueColor = function(){
        var annotation = this.annotation.highlights;
        for(var i=0; i < annotation.length; i++){
            annotation[i].style.backgroundColor = "rgba(101, 176, 195, 0.5)";
            annotation[i].style.paddingTop = "2px";
            annotation[i].style.paddingBottom = "2px";
        }
        this.annotation.color = "blue";
    }

    Editor.prototype.redColor = function(){
        var annotation = this.annotation.highlights;
        for(var i=0; i < annotation.length; i++){
            annotation[i].style.backgroundColor = "rgba(237, 102, 44, 0.5)";
            annotation[i].style.paddingTop = "2px";
            annotation[i].style.paddingBottom = "2px";
        }
        this.annotation.color = "red";
    }

    Editor.prototype.html = "<div class=\"annotator-outer annotator-editor\">\n  <form class=\"annotator-widget\">\n    <ul class=\"annotator-listing\" style=\"width: 0; height: 0;\"></ul>\n    <div class=\"annotator-controls\">\n     <div class=\"colorToChoose\" id=\"yellow\"></div>\n      <div class=\"colorToChoose\" id=\"fucsia\"></div>\n     <div class=\"colorToChoose\" id=\"blue\"></div>\n       <div class=\"colorToChoose\" id=\"red\"></div>\n        <div class=\"borderIconAnnotator\" id=\"borderIconAnnotatorLeft\"></div>\n        <div id=\"cancelHighlight\" class=\"iconRightAnnotator\"></div>\n                <div class=\"borderIconAnnotator\" id=\"borderIconAnnotatorRight\"></div>\n       <div id=\"comment\" class=\"iconRightAnnotator\"></div>\n      <a href=\"#cancel\" class=\"annotator-cancel\">" + _t('Cancel') + "</a>\n<a href=\"#save\" class=\"annotator-save annotator-focus\">" + _t('Save') + "</a>\n    </div>\n  </form>\n</div>";
    ...
    Editor.prototype.comment = function(event) {
        this.publish('comment', [this.annotation]);
    }
  ...
  Annotator.Viewer = (function(_super) {
    ...
    Viewer.prototype.html = {
      element: "<div class=\"annotator-outer annotator-viewer\" style=\"display: none\">\n  <ul class=\"annotator-widget annotator-listing\"></ul>\n</div>",
